...
const Navbar = () => {
  ...
  const getUserData = async () => {
    ...
    const gettingUserData = await axios.get(
      `${process.env.REACT_APP_BACKEND_DOMAIN}/api/user/get/gId/${userData.googleId}`
    );
      ...
      <header className="relative flex flex-wrap sm:justify-start sm:flex-nowrap z-50 w-full bg-blueColor text-sm py-4 dark:bg-gray-800 text-white">
        ...
        >
          <div className="flex items-center justify-between">
            <Link
              className="flex-none text-xl flex flex-row justify-center items-center font-semibold rounded-full px-3.5 py-1 ring-0 focus:ring-2 ring-offset-0 focus:ring-white/50 duration-300"
              to={"/"}
            >
          ...
          >
            <div className="flex flex-col gap-5 mt-5 sm:flex-row sm:items-center sm:justify-end sm:mt-0 sm:pl-5">
              <TwitterShareButton
                className="font-medium text-white rounded-full flex flex-row justify-center items-center w-min !px-2 !py-1 ring-0 focus:ring-2 ring-offset-0 focus:ring-white/50 duration-300"
                title="Checkout xLinks.pro by @AbhiDadhaniya3 to create awesome bio profiles."
                hashtags={["xlinkspro", "profile"]}
              ...
              {user && user.username ? (
                <>
                  <Link
                    className="font-medium text-blueColor-500"
                    aria-current="page"
                    to={`${user.username}`}
                  >
              ...
              <div className="hs-mega-menu" data-hs-mega-menu-auto-close="true">
                <button
                  id="hs-mega-menu-slide-up-dr"
                  type="button"
                  className="hs-mega-menu-toggle hs-mega-menu-open:text-gray-100 flex items-center w-full text-gray-100 hover:text-gray-100 font-medium dark:text-gray-400 dark:hover:text-gray-200"
                >
                  <HiOutlineInformationCircle className="float-left mr-1 text-lg" />
                  About Creator
                  <svg
                    className="ml-2 w-2.5 h-2.5 text-gray-100"
                    width={16}
                    height={16}
                    viewBox="0 0 16 16"
                    fill="none"
                ...
                <div
                  ...
                  aria-labelledby="hs-mega-menu-slide-up-dr"
                >
                  <Link
                    className="flex items-center gap-x-3.5 py-2 px-3 rounded-md text-sm text-gray-800 hover:bg-gray-100 focus:ring-2 focus:ring-blueColor-500 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300"
                    to={"/abhidadhaniya"}
                  >
                  ...
                  <a
                    href="https://www.abhidadhaniya.com/"
                  ...
                  <a
                    href="https://www.twitter.com/abhidadhaniya3"
                    rel="noopener noreferrer"
                    target="_blank"
                    className="flex items-center gap-x-3.5 py-2 px-3 rounded-md text-sm text-gray-800 hover:bg-gray-100 focus:ring-2 focus:ring-blueColor-500 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300"
                  >
                  ...
                  <a
                    href="https://www.buymeacoffee.com/AbhiDadhaniya07"
                    rel="noopener noreferrer"
                    target="_blank"
                    className="flex items-center gap-x-3.5 py-2 px-3 rounded-md text-sm text-gray-800 hover:bg-gray-100 focus:ring-2 focus:ring-blueColor-500 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300"
                  >
              ...
              <div className="hs-dropdown relative">
                {userData.email ? (
                  ...
                  <Link
                    className="font-medium text-white rounded-full flex flex-row justify-start items-center w-min px-2 py-1 ring-0 focus:ring-2 ring-offset-0 focus:ring-white/50 duration-300"
                    to="signin"
                  >
    ...
    <>
      {loggedIn && (
        <button
          ...
          data-hs-modal="#hs-slide-down-animation-modal"
        >
          <CgProfile className="float-left mr-1 text-lg" />
          Your Profile
        </button>
      ...
      <div
        ...
        className="bg-black/75 hs-modal hidden w-full h-full fixed top-0 left-0 z-[60] overflow-x-hidden overflow-y-auto"
      >
          ...
          <div className="flex flex-col bg-white border shadow-sm rounded-xl dark:bg-gray-800 dark:border-gray-700 dark:shadow-slate-700/[.7]">
            ...
            <div className="p-4 overflow-y-auto">
              <p className="mt-1 text-gray-800 dark:text-gray-400 text-base">
                {!loggedIn
                  ? "Signin first to create profile"
                  : "To Create your profile, Go to"}
                {loggedIn ? (
                  <Link
                    to="/dashboard"
                    className="hs-dropdown-toggle text-blueColor hover:text-blueColor/70 focus:outline-none rounded-sm ml-1.5 focus:ring-2 focus:ring-blueColor/70 focus:ring-offset-2 focus:ring-offset-white transition-all"
                    data-hs-modal="#hs-slide-down-animation-modal"
                  >
